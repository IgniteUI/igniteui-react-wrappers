$.ig.react.propTypes.igFinancialChart = {
	...
	rangeSelectorTemplate: PropTypes.object,
	toolbarTemplate: PropTypes.object,
	chartTypePickerTemplate: PropTypes.object,
	trendLineTypePickerTemplate: PropTypes.object,
	volumeTypePickerTemplate: PropTypes.object,
	indicatorMenuTemplate: PropTypes.object,
	overlayPickerTemplate: PropTypes.object,
	...
	volumeType: PropTypes.oneOf([
		"none",
		"column",
		"line",
		"area"
	]),
	xAxisMode: PropTypes.oneOf([
		"ordinal",
		"time"
	]),
	yAxisMode: PropTypes.oneOf([
		"numeric",
		"percentChange"
	]),
	...
	isWindowSyncedToVisibleRange: PropTypes.bool,
	indicatorTypes: PropTypes.object,
	overlayTypes: PropTypes.object,
	yAxisAbbreviateLargeNumbers: PropTypes.bool,
	zoomSliderType: PropTypes.oneOf([
		"none",
		"auto",
		"bar",
		"candle",
	...
	negativeBrushes: PropTypes.object,
	negativeOutlines: PropTypes.object,
	overlayBrushes: PropTypes.object,
	overlayOutlines: PropTypes.object,
	volumeOutlines: PropTypes.object,
	volumeBrushes: PropTypes.object,
	indicatorNegativeBrushes: PropTypes.object,
	indicatorBrushes: PropTypes.object,
	volumeThickness: PropTypes.number,
	overlayThickness: PropTypes.number,
	indicatorThickness: PropTypes.number,
	indicatorDisplayTypes: PropTypes.object,
	indicatorPeriod: PropTypes.number,
	indicatorMultiplier: PropTypes.number,
	indicatorSmoothingPeriod: PropTypes.number,
	indicatorShortPeriod: PropTypes.number,
	indicatorLongPeriod: PropTypes.number,
	indicatorSignalPeriod: PropTypes.number,
	rangeSelectorOptions: PropTypes.object,
	actualRangeSelectorOptions: PropTypes.object,
	customIndicatorNames: PropTypes.object,
	zoomSliderXAxisMajorStroke: PropTypes.string,
	zoomSliderXAxisMajorStrokeThickness: PropTypes.number,
	isLegendVisible: PropTypes.bool,
	financialChartLegend: PropTypes.object,
	xAxisMinimumValue: PropTypes.object,
	xAxisMaximumValue: PropTypes.object,
